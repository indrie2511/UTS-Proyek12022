...
<table class="table">
  ...
  <tbody>
    ...
    $_tanggal_pemeriksaan = isset ($_POST['tanggal_pemeriksaan']) ? $_POST['tanggal_pemeriksaan'] : '';
    $_kode = isset ($_POST['kode']) ? $_POST['kode'] : '';
    ...
    $bb4 = new bmi ($_kode, $_nama, $_gender, $_berat, $_tinggi);
    $bb4->tanggal = $_tanggal_pemeriksaan;
